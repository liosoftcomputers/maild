        ...
        <nav class="side-nav">
            <a href="{{ route('dashboard') }}" class="intro-x flex items-center">
                ...
                @if (checkDBConnection() == true && Schema::hasTable('organization_setups'))
                        ...
                        @else
                            <img alt="#maildoll" class="m-auto" src="{{ logo() }}">
                        @endif

                @else
                    <img alt="{{ maildoll() }}" class="m-auto" src="#maildoll">
                @endif
            ...
            <ul>
                ...
                @can('Admin')
                    ...
                    <li>
                        <a href="{{ route('system.smtp.configure') }}" class="side-menu {{ request()->routeIs('system.smtp.configure') ? 'side-menu--active' : '' }}">
                        <div class="{{ request()->routeIs('system.smtp.configure') ? 'mldl-active-menu' : 'flex items-center' }}">
                            <div class="side-menu__icon">
...
<div class="{{ request()->routeIs('campaign.*') ? 'mldl-active-menu' : 'flex items-center' }}">
                    ...
                    <ul class="d-none {{
                        request()->routeIs('campaign.*') || request()->routeIs('tracker.*') ? 'side-menu__sub-open' : ''
                    }}">
                        <li>
                            ...
                            <a href="{{ route('campaign.schedule.emails') }}" class="side-menu {{ request()->routeIs('campaign.schedule.emails') ? 'side-menu--active' : '' }}">
                                <div class="side-menu__icon">
                                    <i data-feather="align-left"></i>
                                </div>
                                <div class="side-menu__title">
...
<div class="{{ request()->routeIs('queue.*') ? 'mldl-active-menu' : 'flex items-center' }}">
                ...
                {{-- AppApi --}}
                <li class="hidden">
                    <a href="{{ route('app.api.index') }}" class="side-menu 
                    {{ request()->routeIs('app.api.index') ? 'side-menu--active' : '' }}">
                        
                        <div class="{{ request()->routeIs('app.api.index') ? 'mldl-active-menu' : 'flex items-center' }}">
                        <div class="side-menu__icon">
                            <i data-feather="message-square"></i>
                        </div>
                        <div class="side-menu__title">
                ...
                <li>
                    <a href="{{ route('chat.provider') }}" class="side-menu 
                    {{ request()->routeIs('chat.provider') || 
                    request()->routeIs('chat.edit') ? 'side-menu--active' : '' }}">
                        
                        <div class="{{ request()->routeIs('chat.provider') ? 'mldl-active-menu' : 'flex items-center' }}">
                        <div class="side-menu__icon">
                            <i data-feather="message-square"></i>
                        </div>
                        <div class="side-menu__title">
