...
<div class="top-bar">
 ...
 <!-- BEGIN: queue retry -->
    <div class="intro-x relative mr-3 sm:mr-6 blinking md:hidden">
                ...
                @forelse (notifications() as $key => $notification)
                    <div class="cursor-pointer relative flex items-center {{ $key ? 'mt-5' : '' }}">
                        <div class="w-12 h-12 flex-none image-fit mr-1">
                            <img alt="Maildoll" class="rounded-full" src="{{ commonAvatar($notification->message) }}">
        ...
        <div class="dropdown-box w-56">
            <div class="dropdown-box__content box bg-theme-38 dark:bg-dark-6 text-white">
                ...
                <div class="p-2">
                    ...
                    <a href="https://maildoll.gitbook.io/maildoll-email-and-sms-marketing-application" target="_blank" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md">
                        <i data-feather="book-open" class="w-4 h-4 mr-2"></i> @translate(Documentation)
                    </a>
                        
                    <a href="{{ route('help') }}" target="_blank" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md">
                        <i data-feather="help-circle" class="w-4 h-4 mr-2"></i> @translate(Help)
                    </a>
                    @endcan
