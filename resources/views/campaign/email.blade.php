...
@section('subcontent')
  <h2 class="intro-y text-lg font-medium mt-10">@translate(Campaign List)</h2>
    ...
    {{-- NOTE --}}
    <div class="bg-indigo-900 text-center py-4 lg:px-4 rounded">
            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="text-center whitespace-no-wrap">@translate(MAIL SERVER)</th>
                        ...
                        <th class="text-center whitespace-no-wrap">@translate(SCHEDULE MAILING)</th>
                ...
                <tbody class="campaignEmailName">
                    @forelse ($campaigns as $campaign)
                        <tr class="intro-x">
                            ...
                            <td class="text-center normal-case">{{ Str::upper($campaign->relationWithSmtpServer->name ?? 'No Server Found') }}</td>
