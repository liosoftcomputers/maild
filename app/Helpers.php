...
function chatProviders()
{
  ...
  */
  ...
  function app_key()
  {
    ...
    $key = Str::lower(orgName()) . '-' . bin2hex($bytes);
    return $key;
  }
  ...
  function app_secret_key()
  {
    ...
    $secret_key = Str::lower(orgName()) . '-' . bin2hex($bytes .time());
    return $secret_key;
  }
  ...
  */
   ...
   */
   ...
   {
       return $smtp_provider_list = ['Gmail', 'Yahoo', 'Webmail', 'Mailgun', 'Zoho', 'Elastic', 'Amazon SES', 'Mailtrap'];
   }
